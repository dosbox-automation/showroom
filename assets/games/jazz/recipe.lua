...
--
-- Standalone install recipe for Jazz Jackrabbit shareware (Epic CD
-- self-extractor JAZZSW11.EXE). Epic extractor family: runs on D:
-- (extracts dir), installs to C: (staging), sound set via the shipped
-- text-mode SETUP.EXE. Unlike Epic Pinball's list, Jazz's sound card
-- menu has no PC Speaker entry, so SB16 is four downs, not five. The
...
-- Card list: No Sound Card / GUS / PAS / SB / SB16 / Clone / Pro.
...
if not dosbox.wait_for_text("JAZZ>", 1800) then
